...
import {
  Card,
  CardsProvider,
} from "../../features/productManage/provider/PetProvider"
  ...
  const cards: Card[] = [
    {
      ...
      type: "Cat",
      description:
        "A dumdass cat who like to eat luxury food every meal. Sleep all day all-night don't do any thing except snoring",
      isAdopt: true,
      updatedAt: "Diao Kon",
    },
    {
